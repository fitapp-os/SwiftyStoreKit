//
//  CodeRedemptionController.swift
//  SwiftyStoreKit
//
//  Created by Eman Basic on 17.05.23.
//  Copyright © 2023 musevisions. All rights reserved.
//
...
final class CodeRedemptionController: TransactionController {
    ...
    func processTransaction(_ transaction: SKPaymentTransaction, on paymentQueue: PaymentQueue) -> Bool {
        ...
        guard let codeRedemption = self.codeRedemption else { return false }
